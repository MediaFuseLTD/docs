...
description: "How to authenticate requests to the Chainwire API"
---
...
To manage your API keys, navigate to the **Organization Details** page within the Chainwire dashboard.
